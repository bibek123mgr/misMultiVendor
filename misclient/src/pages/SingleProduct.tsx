...
import { fetchProduct } from '../store/product/productApi';
...
const SingleProduct: React.FC = () => {
    ...
    const { product }: { product: any } = useAppSelector((store) => store.product.data)
                ...
                <div className="flex flex-wrap -mx-4">
                    <div className="w-full md:w-1/2 px-4 mb-8 flex flex-col items-center">
                        <img
                            src={mainImage}
                            alt="Product"
                            className="rounded-lg shadow-md mb-4 lg:h-[500px] lg:w-[500px] w-[400px] h=[400px]"
                            id="mainImage"
                        />
                    ...
                    <div className="w-full md:w-1/2 px-4">
                        ...
                        <div className="mb-4">
                            <span className="text-2xl font-bold mr-2">Rs.{product.price.originalPrice}</span>
